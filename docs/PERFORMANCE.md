...
### SDL2 vs SDL3 renderer throughput, 2026-07-28

Folded in from a standalone `docs/SDL3_BENCHMARK_2026-07-28.md`, which
nothing linked. A dated point-in-time result is what this section is for.
